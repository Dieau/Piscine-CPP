...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/08 13:19:31 by alakhdar          #+#    #+#             */
/*   Updated: 2022/11/08 13:19:31 by alakhdar         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	Form::execute(const Bureaucrat& signat) const
{
	if (signat.getGrade() > this->_to_exec)
	{
		throw(GradeTooLowException());
	}
}
